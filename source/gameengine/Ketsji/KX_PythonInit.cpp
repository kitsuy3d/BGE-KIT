...
PyMODINIT_FUNC initApplicationPythonBinding()
{
	...
	PyDict_SetItemString(d, "range_version", Py_BuildValue("(ii)",
		RANGE_VERSION, RANGE_SUBVERSION));

	PyDict_SetItemString(d, "range_version_string", PyUnicode_FromFormat("%d.%d",
		RANGE_VERSION, RANGE_SUBVERSION));
