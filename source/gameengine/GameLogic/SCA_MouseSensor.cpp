...
bool SCA_MouseSensor::Evaluate()
{
	...
	switch (m_mousemode) {
		...
		case KX_MOUSESENSORMODE_LEFTTHUMBMOUSE:
		case KX_MOUSESENSORMODE_RIGHTTHUMBMOUSE:
		...
		case KX_MOUSESENSORMODE_BUTTON7:
		{
			static const SCA_IInputDevice::SCA_EnumInputs convertTable[KX_MOUSESENSORMODE_MAX] = {
				...
				SCA_IInputDevice::LEFTTHUMBMOUSE,   // KX_MOUSESENSORMODE_LEFTTHUMBMOUSE
				SCA_IInputDevice::RIGHTTHUMBMOUSE,   // KX_MOUSESENSORMODE_RIGHTTHUMBMOUSE
...
EXP_PYMETHODDEF_DOC_O(SCA_MouseSensor, getButtonStatus,
...
PyMethodDef SCA_MouseSensor::Methods[] = {
	EXP_PYMETHODTABLE_O(SCA_MouseSensor, getButtonStatus),
