...
typedef struct Main {
	...
	short rangeversionfile, rangesubversionfile;
...
#define MAIN_VERSION_RANGE_ATLEAST(main, ver, subver) \
	((main)->rangeversionfile > (ver) || (main->rangeversionfile == (ver) && (main)->rangesubversionfile >= (subver)))
